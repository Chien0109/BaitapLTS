...
!function(a, b) {
            ...
            for (var g = 0; g < f.length; g++)
                !function(a, b) {
                    google.maps.event.addDomListener(a, b, function(a) {
                        -1 != navigator.userAgent.toLowerCase().indexOf("msie") && document.all ? (a.cancelBubble = !0,
    ...
    j.prototype.addLayer = function(a, b) {
        ...
        return void 0 !== c ? ("function" == typeof c.setOptions && c.setOptions(b),
    ...
    j.once = function(a, b, c) {
        return -1 == j.custom_events.indexOf(a) ? (b instanceof j && (b = b.map),
        google.maps.event.addListenerOnce(b, a, c)) : void 0
    }
    ,
